...
$string['bodyids'] = 'Body IDs';
$string['chatregiontitle'] = 'Ask Sherpa';
$string['chatunavailable'] = 'The AI assistant is not available for you here.';
$string['confirmimport'] = 'Import now';
$string['csvfile'] = 'CSV file';
$string['csvfile_help'] = 'Upload a semicolon separated CSV file with the columns "Tutorial", "URL", "Moodle Body IDs" and "Lang Strings (component:key)". The first row is treated as a header and skipped. Multiple body IDs or language strings within a cell are separated by a semicolon. Language strings must use the "component:key" syntax (for example "core:login").';
...
$string['importheading'] = 'Import tutorials from CSV';
$string['importheading_desc'] = 'Import tutorials from a CSV file. Each row becomes a source; its body IDs and language strings become placements that are mapped to the source. Existing sources, placements and mappings are reused instead of duplicated.';
$string['importnothing'] = 'The uploaded file did not contain any valid rows.';
$string['importpreview'] = 'Check and edit the import data';
$string['importpreviewintro'] = 'Review the parsed rows below. You can edit any value before importing. Empty rows are skipped.';
$string['importsummary'] = 'Import finished: {$a->sourcescreated} source(s) created, {$a->sourcesreused} reused; {$a->placementscreated} placement(s) created, {$a->placementsreused} reused; {$a->mappingscreated} mapping(s) created, {$a->mappingsskipped} skipped.';
$string['importtutorials'] = 'Import tutorials';
$string['langstrings'] = 'Language strings';
...
$string['pagehelp_buttonlabel'] = 'Help for this page';
$string['pagehelp_chatsystemprompt'] = 'You are "Sherpa", a helpful assistant for the Moodle learning platform. The user is currently on the page "{$a->title}". Help them understand what they can do on this page. Further sources (URLs): {$a->urls}. Answer in simple, clear language and stay within the given context.';
$string['pagehelp_title'] = 'Help for this page';
...
$string['title'] = 'Title';
$string['type'] = 'Type';
$string['type_bodyid'] = 'Page (body id)';
